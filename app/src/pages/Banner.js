            ...
            <Paper>
                <div className='banner-container'>
                    ...
                    <div className='banner-text tracking-in-expand'>
                        ...
                        <HashLink smooth to="/LogIn" className='text-style'>
                            <div> <Button sx={{ mt: 2 }} variant="contained" className="CheckButton">
                                Log in
                            </Button></div>
                        ...
                        <HashLink smooth to="/Services" className='text-style'>
                            <div>
                                <Button sx={{ mt: 2 }} variant="contained" className="CheckButton">
                                    Our services
                                </Button></div>
