...
const WhyUs = () => {
    ...
    return (
        ...
        <Box sx={{ bgcolor: '#2187ab', color: 'white', p: 2, mb: 2, textAlign: "center" }}>
            <Container maxWidth="xl">
                                    ...
                                    <Card sx={{
                                        ...
                                        <CardActions>
                                            <Typography sx={{ mx: 2, p: 2, textAlign: "end" }} >
                                                <Link className='text-style' to="/services" color="#2187ab">
                                                    See More Details...
                                                </Link>
                                            </Typography>
                                        </CardActions>
                ...
                <Typography sx={{ mx: 2, p: 2, textAlign: "end" }} >
                    <HashLink smooth to="/services#services" className='text-style' color="#2187ab">
                        See All services
                    </HashLink>
                </Typography>
